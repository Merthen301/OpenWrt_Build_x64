#!/bin/bash
#===============================================
# Description: 2305_x64_Merthen301 DIY script part 2
# File name: 2305_x64_Merthen301_diy-part2.sh
# Lisence: MIT
# By: Merthen301
#===============================================
...
sed -i 's/LEDE/OpenWrt_2305_x64_旁路由版 by Merthen301 build/g' package/lean/default-settings/files/zzz-default-settings

# 修改右下角脚本版本信息
sed -i 's/<a class=\"luci-link\" target=\"_blank\">Powered by <%= ver.luciname %> (<%= ver.luciversion %>)<\/a>/OpenWrt_2305_x64_旁路由版 by Merthen301 build @R'"$build_date"'/' package/luci-theme-argon/luasrc/view/themes/argon/footer.htm
sed -i 's|<a href="https://github.com/jerrykuku/luci-theme-argon" target="_blank">ArgonTheme <%# vPKG_VERSION %></a>|<a class="luci-link" >🌐固件编译者：【Merthen301】</a>|' package/luci-theme-argon/luasrc/view/themes/argon/footer.htm
...
sed -i "/<a class=\"luci-link\"/d; /<a href=\"https:\/\/github.com\/jerrykuku\/luci-theme-argon\"/d; s|<%= ver.distversion %>|OpenWrt_2305_x64_旁路由版 by Merthen301 build @R$build_date|" package/luci-theme-argon/luasrc/view/themes/argon/footer_login.htm
