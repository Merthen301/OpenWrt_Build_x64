...
sed -i "/uci commit system/i\uci set system.@system[0].hostname='OpenWrt-Merthen301'" package/lean/default-settings/files/zzz-default-settings
sed -i "s/hostname='.*'/hostname='OpenWrt'/g" ./package/base-files/files/bin/config_generate

# 修改默认IP
sed -i 's/192.168.3.1/192.168.18.1/g' package/base-files/files/bin/config_generate
sed -i 's/192.168.3.1/192.168.18.1/g' package/base-files/luci2/bin/config_generate
...
sed -i 's/LEDE/OpenWrt_2305_x64_全功能版 by Merthen301 build/g' package/lean/default-settings/files/zzz-default-settings

# 修改右下角脚本版本信息
sed -i 's/<a target=\"_blank\">Powered by <%= ver.luciname %> (<%= ver.luciversion %>)<\/a>/OpenWrt_2305_x64_全功能版 by Merthen301 build @R'"$build_date"'/' package/luci-theme-argon/luasrc/view/themes/argon/footer.htm
sed -i 's|<a href="https://github.com/jerrykuku/luci-theme-argon" target="_blank">ArgonTheme <%# vPKG_VERSION %></a>|<a class="luci-link" target="_blank">🌐固件编译者：【Merthen301】</a>|' package/luci-theme-argon/luasrc/view/themes/argon/footer.htm
...
sed -i "/<a class=\"luci-link\"/d; /<a href=\"https:\/\/github.com\/jerrykuku\/luci-theme-argon\"/d; s|<%= ver.distversion %>|OpenWrt_2305_x64_全功能版 by Merthen301 build @R$build_date|" package/luci-theme-argon/luasrc/view/themes/argon/footer_login.htm
